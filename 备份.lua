...
_G.Settings = {
	...
	SeaEvent = {
		...
		["Dodge Seabeasts Attack"] = false,
		["Dodge Terrorshark Attack"] = false
	},
	SettingSea = {
		Lightning = false,
		["Increase Boat Speed"] = false,
		["No Clip Rock"] = false,
		["Use Devil Fruit Skill"] = false,
		["Use Melee Skill"] = false,
		["Use Sword Skill"] = false,
		["Use Gun Skill"] = false,
		["Devil Fruit Z Skill"] = false,
		["Devil Fruit X Skill"] = false,
		["Devil Fruit C Skill"] = false,
...
function Hop()
	local module = (loadstring(game:HttpGet("https://raw.githubusercontent.com/loveyouone/lj/refs/heads/main/%E6%94%BB%E5%87%BB.lua")))();
					...
					if game.Workspace.Enemies:FindFirstChild(Mon) then
						for i, v in pairs((game:GetService("Workspace")).Enemies:GetChildren()) do
							if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
								if v.Name == Mon then
									repeat
										(game:GetService("RunService")).Heartbeat:wait(1.5);
	...
	pcall(function()
		while task.wait(1) do
			if game.Workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") then
				MirageStatusSeaStackParagraph:SetDesc("已生成");
			else
				MirageStatusSeaStackParagraph:SetDesc("未生成");
			end;
			if game.Workspace._WorldOrigin.Locations:FindFirstChild("Kitsune Island") then
				KitsuneStatusSeaStackParagraph:SetDesc("已生成");
			else
				KitsuneStatusSeaStackParagraph:SetDesc("未生成");
			end;
			if game.Workspace._WorldOrigin.Locations:FindFirstChild("Frozen Dimension") then
				FrozenStatusSeaStackParagraph:SetDesc("已生成");
			else
				FrozenStatusSeaStackParagraph:SetDesc("â未生成");
			end;
			if game.Workspace._WorldOrigin.Locations:FindFirstChild("Prehistoric Island") then
				PrehistoricStatusSeaStackParagraph:SetDesc("已生成");
			else
				PrehistoricStatusSeaStackParagraph:SetDesc("未生成");
			end;
		end;
	end);
end);
	...
	while task.wait(1.5) do
		pcall(function()
			if (game:GetService("Lighting")).Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149431" then
				MoonServerParagraph:SetDesc("100%");
			elseif (game:GetService("Lighting")).Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149052" then
				MoonServerParagraph:SetDesc("75%");
			elseif (game:GetService("Lighting")).Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709143733" then
				MoonServerParagraph:SetDesc("50%");
			elseif (game:GetService("Lighting")).Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709150401" then
				MoonServerParagraph:SetDesc("25%");
			elseif (game:GetService("Lighting")).Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149680" then
				MoonServerParagraph:SetDesc("15%");
			else
				MoonServerParagraph:SetDesc("0%");
			end;
		end);
	end;
end);
spawn(function()
	pcall(function()
		while task.wait(1) do
			if World3 then
				if game.Workspace._WorldOrigin.Locations:FindFirstChild("Kitsune Island") then
					KitsuneStatusParagraph:SetDesc("✅ 已生成");
				else
					KitsuneStatusParagraph:SetDesc("❌ 未生成");
				end;
			else
				KitsuneStatusParagraph:SetDesc("三海事件");
			end;
		end;
	end);
end);
spawn(function()
	pcall(function()
		while task.wait(1) do
			if World3 then
				if game.Workspace._WorldOrigin.Locations:FindFirstChild("Prehistoric Island") then
					PrehistoricStatusParagraph:SetDesc("✅ 已生成");
				else
					PrehistoricStatusParagraph:SetDesc("❌ 未生成");
				end;
			else
				PrehistoricStatusParagraph:SetDesc("三海事件");
			end;
		end;
	end);
end);
spawn(function()
	pcall(function()
		while task.wait(1) do
			if game.Workspace._WorldOrigin.Locations:FindFirstChild("Frozen Dimension") then
				FrozenStatusParagraph:SetDesc("✅ 已生成");
			else
				FrozenStatusParagraph:SetDesc("❌ 未生成");
			end;
		end;
	end);
end);
	...
	pcall(function()
		while task.wait(1) do
			if World2 or World3 then
				if game.Workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") then
					MirageStatusParagraph:SetDesc("✅ 已生成");
				else
					MirageStatusParagraph:SetDesc("❌ 未生成");
				end;
			else
				MirageStatusParagraph:SetDesc("三海事件");
			end;
		end;
	end);
end);
spawn(function()
	while task.wait(1) do
		pcall(function()
			...
			if response then
				HakiDealerStatusParagraph:SetDesc("✅ 已生成");
			else
				HakiDealerStatusParagraph:SetDesc("❌ 未生成");
			end;
		end);
	end;
end);
